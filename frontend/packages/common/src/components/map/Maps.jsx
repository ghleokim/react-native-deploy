  ...
  return (
    <View>
      ...
      <TouchableOpacity style={{
        position: 'absolute', right: 20, bottom: 30, flexDirection: 'row', paddingHorizontal: 3,
      ...
      disabled={ !mapStore.boundsChanged }
      ...
      <TouchableOpacity style={{
        position: 'absolute', bottom: 30, left: (mainStore.screenWidth - 100) / 2,
